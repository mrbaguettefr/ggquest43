  ...
  [
    ...
    [
      "skeleton_archer",
      {
        ...
        battleScale: 0.45,
        explorationTexture: "skeleton-archer-battle-idle",
        explorationAnimation: "skeleton-archer-battle-idle",
    ...
    [
      "wolf_rider",
      {
        ...
        hp: 46,
        damage: 10,
        battleTexture: "wolf-rider2-idle",
        battleAnimation: "wolf-rider2-idle",
        battleAttackTexture: "wolf-rider2-battle-attack",
        battleAttackAnimation: "wolf-rider2-battle-attack",
        battleDeathTexture: "wolf-rider2-battle-die",
        battleDeathAnimation: "wolf-rider2-battle-die",
        battleScale: 0.58,
        explorationTexture: "wolf-rider2-idle",
        explorationAnimation: "wolf-rider2-idle",
        explorationScale: 0.26,
      },
    ],
    [
      "magma_golem",
      {
        ...
        battleScale: 0.5,
        explorationTexture: "magma-golem-battle-idle",
        explorationAnimation: "magma-golem-battle-idle",
        explorationScale: 0.22,
      },
    ],
    [
      "revenant",
      {
        ...
        battleScale: 0.48,
        explorationTexture: "revenant-battle-idle",
        explorationAnimation: "revenant-battle-idle",
        explorationScale: 0.22,
      },
    ],
    [
    ...
    [
      "cyberdemon",
      {
        ...
        battleScale: 0.58,
        explorationTexture: "cyberdemon-battle-idle",
        explorationAnimation: "cyberdemon-battle-idle",
    ...
    [
      "infernal_warlock",
      {
        ...
        battleScale: 0.48,
        explorationTexture: "infernal-warlock-battle-idle",
        explorationAnimation: "infernal-warlock-battle-idle",
        explorationScale: 0.22,
      },
    ],
  ].map(
  ...
  enemies: [
    {
      ...
      battleScale: 0.58,
      explorationTexture: "king-slime-boss-battle-idle",
      explorationAnimation: "king-slime-boss-battle-idle",
