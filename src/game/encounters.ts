...
const normalizeEnemyKey = (key: string) => key.toLowerCase().replace(/-/g, '_').replace(/\s+/g, '_');
...
const createPreset = (preset: EnemyPreset, count = 1, battlefieldPosition?: number): Enemy => {
